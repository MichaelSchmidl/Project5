...
#define SCL_H       DIO->CFG[SCL_DIO_NUM] = DIO_MODE_INPUT  | DIO_STRONG_PULL_UP | DIO_LPF_DISABLE | DIO_6X_DRIVE
#define Is_SCL_high DIO_DATA->ALIAS[SCL_DIO_NUM] == 1
#define SDA_0       DIO->CFG[SDA_DIO_NUM] = DIO_MODE_GPIO_OUT_0
#define SDA_H       DIO->CFG[SDA_DIO_NUM] = DIO_MODE_INPUT  | DIO_STRONG_PULL_UP | DIO_LPF_DISABLE | DIO_6X_DRIVE
