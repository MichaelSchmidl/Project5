 ...
 *
 *  Da BRAILLE f�r Zahlen und Buchstaben den gleichen Code verwendet, muss vor jeder Zahl ein # stehen.
 *  Ebenso werden Gro�buchstaben durch vorangestelltes $ angezeigt.
 *  "Test123" -> "$test#1#2#3"
 */
