...
#define PRIVATE_BDADDR                  { 0x94, 0x00, 0x00, 0xff, 0xff, 0xF7 }
...
#define APP_DFLT_DEVICE_NAME            "EasterEgg_Keyboard"
...
struct ble_env_tag
{
    ...
    /* Bond information, if enabled */
    BondInfo_Type bond_info;
    ...
    /* Flag for device connection establishment with bonded devices. */
    bool connection_with_bond;

    /* store central device address trying to connect to the peripheral for encryption */
    uint8_t central_addr[BDADDR_LENGTH];
};
